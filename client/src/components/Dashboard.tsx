									...
									<>
										...
										<div className="intro">
											...
											<div className="intro-blurb">
												...
												<p>
													Use it to keep track of the movies you've watched, the books you've read
													or the albums you own.
												</p>
												<p>
													Mediator is a work in progress
													<br />
													by Field 2 Design /{' '}
													<a href="https://bendunkle.com" target="_blank" rel="noreferrer">
														Ben Dunkle
													</a>
													.
												</p>
